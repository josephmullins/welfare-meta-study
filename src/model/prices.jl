...
logwage(p,md::model_data,kτ::Int64,kη::Int64,t::Int64) = p.βw[kτ] + p.βw[p.Kτ+1]*md.unemp[min(end,t)] + p.βw[p.Kτ+2]*((md.age0-18)*4+t) + p.ση*p.ηgrid[kη-1]
...
function logpriceF(p,md::model_data,kτ::Int64,t::Int64) 
